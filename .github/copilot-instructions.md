# GitHub Copilot Instructions — Function Registry Protocol (FRP) v1.0
...
```
- Pipe rows, NO alignment padding. desc ≤ 12 words. refs = grep'd call-site count (`-` allowed in Stage 1).
...
## 10. Definition of done — self-check before the final reply
