...
|refresh|L3|()|canvas/app.js|9|重画卡片、连线和底部操作条|
|setGraph|L3|(graph)|canvas/app.js|5|装入一张新项目图并重置视图|
|fitView|L3|()|canvas/app.js|4|缩放平移到能看到整张图|
...
|selectInRect|L3|(x1,y1,x2,y2,additive)|canvas/app.js|1|框选矩形内的卡片加入选区|
...
|runSearch|L3|()|canvas/ui.js|2|搜索过滤：不匹配的卡片压暗|
|fileByPath|L1|(p)|canvas/ui.js|2|按路径找到文件对象|
